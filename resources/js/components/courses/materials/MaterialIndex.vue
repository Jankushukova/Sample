<template>
    <div class="card-body ">
        ...
        <div class="card-description row">
            ...
            <router-link tag="button" :to="{name: 'createMaterial', params: {lesson_id: lessonId,course_id:courseId}}" type="button"
            ...
            <div class="col-md-4 grid-margin stretch-card" v-for="material, index in materials">
                <div class="card" >
                    <div class="card-body">
                        ...
                        <p class="text-right">
                            <router-link tag="button" :to="{name: 'editMaterial', params: {material_id:material.id,lesson_id: lessonId,course_id:courseId}}" type="button"
