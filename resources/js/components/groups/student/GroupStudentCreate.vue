<template>
    <div class="card-body">
        ...
        <div class="card-description row">
            <router-link tag="button" :to="{name: 'indexGroupStudents', params: {group_id: group_users.group_id}}" type="button"
                    ...
                    if(result){
                        ...
                        axios.post('/api/v1/groupsStudents', newGroupStudent)
                            .then(function (resp) {
                                ...
                                app.$router.push({name: 'indexGroupStudents', params: {group_id: app.group_users.group_id}});
                            })
                            .catch(function (resp) {
                                console.log(resp);
